...
void CustomShape::setSize( const sf::Vector2f& size )
{
	m_size = size;
	update( );
}
...
////////////////////////////////////////////////////////////
const sf::Vector2f& CustomShape::getSize( ) const
{
	return m_size;
}
...
////////////////////////////////////////////////////////////
void CustomShape::setTexture( const sf::Texture* texture, bool resetRect )
{
	if( texture )
	{
...
////////////////////////////////////////////////////////////
const sf::Texture* CustomShape::getTexture( ) const
{
	return m_texture;
}
...
////////////////////////////////////////////////////////////
void CustomShape::setTextureRect( const sf::IntRect& rect )
{
	m_textureRect = rect;
	updateTexCoords( );
}
...
////////////////////////////////////////////////////////////
const sf::IntRect& CustomShape::getTextureRect( ) const
{
...
////////////////////////////////////////////////////////////
void CustomShape::setFillColor( const sf::Color& color )
{
	m_fillColor = color;
	updateFillColors( );
}
...
////////////////////////////////////////////////////////////
const sf::Color& CustomShape::getFillColor( ) const
{
	return m_fillColor;
}
...
////////////////////////////////////////////////////////////
void CustomShape::setOutlineColor( const sf::Color& color )
{
...
////////////////////////////////////////////////////////////
const sf::Color& CustomShape::getOutlineColor( ) const
{
...
////////////////////////////////////////////////////////////
void CustomShape::setOutlineThickness( float thickness )
{
...
////////////////////////////////////////////////////////////
float CustomShape::getOutlineThickness( ) const
{
...
////////////////////////////////////////////////////////////
sf::FloatRect CustomShape::getLocalBounds( ) const
{
	return m_bounds;
}
...
////////////////////////////////////////////////////////////
sf::FloatRect CustomShape::getGlobalBounds( ) const
{
...
////////////////////////////////////////////////////////////
void CustomShape::updateFillColors( )
{
...
////////////////////////////////////////////////////////////
void CustomShape::updateTexCoords( )
{
	for( std::size_t i = 0; i < m_vertices.getVertexCount( ); ++i )
	{
...
////////////////////////////////////////////////////////////
void CustomShape::updateOutline( )
{
...
////////////////////////////////////////////////////////////
void CustomShape::updateOutlineColors( )
{
...
sf::VertexArray CustomShape::getOutlineVertices( ) const {
	return m_outlineVertices;
}

void CustomShape::setOutlineVertices( sf::VertexArray& vertices ) {
	m_outlineVertices = vertices;
}